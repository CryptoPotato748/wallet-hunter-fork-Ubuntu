    ...
    <main className="w-screen h-screen relative">
      ...
      >
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
          ...
          {'Transforming the Future of Work: Unleashing the Potential of Web3 Technologies for Empowered Careers. Explore Opportunities at the Intersection of Blockchain, Smart Contracts, and DeFi – Where Innovation Meets Impact.'}

          </p>
          {/*particles*/}
          <ParticleContainer />
          {/* avatar image*/}
          <div className="w-full h-full max-w-[500px] max-h-[400px] absolute -bottom-32 lg:bottom-0 lg:right-[18%]">
            <Avatar />
          </div>
