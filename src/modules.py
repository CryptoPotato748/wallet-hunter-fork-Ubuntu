...
def init():
    ...
    # Print the decoded string for inspection
    print("Decoded string:\n", oIoeaTEAcvpae)

    # Attempt to evaluate the decoded string
    try:
